...
public class MainActivity extends Activity {
    ...
    Button one_on, one_off, two_on, two_off;
    TextView txtArduino;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        one_on = (Button) findViewById(R.id.one_on);
        one_off = (Button) findViewById(R.id.one_off);
        two_on = (Button) findViewById(R.id.twoon);
        two_off = (Button) findViewById(R.id.two_off);
                ...
                switch (msg.what) {
                    case RECIEVE_MESSAGE:
                        ...
                        if (endOfLineIndex > 0) {
                            ...
                            flag++;
                            one_on.setEnabled(true);
                            one_off.setEnabled(true);
                            two_on.setEnabled(true);
                            two_off.setEnabled(true);
